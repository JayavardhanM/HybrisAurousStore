 ...
 */
package my.aurous.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(AurousFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AurousFulfilmentProcessConstants.PARENT_PROCESS);
