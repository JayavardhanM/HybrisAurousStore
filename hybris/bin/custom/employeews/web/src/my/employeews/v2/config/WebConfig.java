 ...
 */
package my.employeews.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.webservicescommons.swagger.services.ApiVendorExtensionService;
import my.employeews.constants.YcommercewebservicesConstants;
import my.employeews.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "employeews.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "employeews.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "employeews.oauth2.tokenUrl";

	private static final String DESC = "employeews.v2.description";
	private static final String TITLE = "employeews.v2.title";
	private static final String VERSION = "employeews.v2.version";
	private static final String LICENSE = "employeews.v2.license";
	private static final String LICENSE_URL = "employeews.v2.license.url";
	...
	private static final String LEGACY_CONTENT_NEGOTIATION = "employeews.content.negotiation.legacy";
