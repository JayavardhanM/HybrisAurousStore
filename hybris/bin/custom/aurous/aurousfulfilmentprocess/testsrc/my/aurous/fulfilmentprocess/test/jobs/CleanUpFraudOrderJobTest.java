 ...
 */
package my.aurous.fulfilmentprocess.test.jobs;
...
import my.aurous.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = AurousFulfilmentProcessConstants.ORDER_PROCESS_NAME;
