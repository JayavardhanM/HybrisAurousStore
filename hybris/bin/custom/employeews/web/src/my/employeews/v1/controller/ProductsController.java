 ...
 */
package my.employeews.v1.controller;

import static my.employeews.constants.YcommercewebservicesConstants.ENUM_VALUES_SEPARATOR;
...
import my.employeews.formatters.WsDateFormatter;
import my.employeews.product.data.ProductDataList;
import my.employeews.product.data.SuggestionDataList;
import my.employeews.queues.data.ProductExpressUpdateElementData;
import my.employeews.queues.data.ProductExpressUpdateElementDataList;
import my.employeews.queues.impl.ProductExpressUpdateQueue;
import my.employeews.stock.CommerceStockFacade;
import my.employeews.util.ws.SearchQueryCodec;
import my.employeews.validator.PointOfServiceValidator;
...
public class ProductsController extends BaseController
{
	 ...
	 * {@link my.employeews.populator.HttpRequestReviewDataPopulator} to populate review data
