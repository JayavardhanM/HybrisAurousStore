...
import my.aurous.test.constants.AurousTestConstants;
import my.aurous.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AurousTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/auroustest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/auroustest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/auroustest/import/cstickets.impex");
			...
			importImpexFile(context, "/auroustest/import/csquotes.impex");
		}
	}
}
