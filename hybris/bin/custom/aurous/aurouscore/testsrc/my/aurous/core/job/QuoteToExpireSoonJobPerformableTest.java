 ...
 */
package my.aurous.core.job;

import static my.aurous.core.job.QuoteToExpireSoonJobPerformable.DAYS_TO_EXPIRE;
import static my.aurous.core.job.QuoteToExpireSoonJobPerformable.DEFAULT_DAYS_TO_EXPIRE;
